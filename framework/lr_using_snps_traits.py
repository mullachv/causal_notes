...
def main(argv):
  ...
  assert len(argv) == 1
  (trainx, trainy, trainl, trainz, trainw, testx, testy, testl, testz, testw) = load_data('small')
  ...
  def input_train():
    return (
		...
		trainx.batch(128).repeat().make_one_shot_iterator().get_next())

  # Build the validation input_fn.
  def input_test():
    return (testx.batch(128)
